...
@Entity
@NamedQueries({
    @NamedQuery(name = "Work.findAll", query = "SELECT w FROM Work AS w"),
    @NamedQuery(name = "Work.findByStr", query = "SELECT w FROM Work AS w WHERE ( w.name LIKE :name ) or ( w.workdesc LIKE :name )"),
    })
