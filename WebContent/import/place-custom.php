...
<body>
  ...
  <form action="http://localhost:8080/seichi/work" method="POST">
    <label>聖地名<input type="text" name="name" value="{$input["name"]}"></label>
    <label>聖地名<input type="text" name="workid" value="{$input["workid"]}"></label>
    <label>聖地の説明<textarea name="placedesc">{$input["placedesc"]}</textarea></label>
    <label>聖地の住所<input type="text" name="img" value="{$input["address"]}"></label>
    <label>聖地の緯度<input type="text" name="img" value="{$input["lat"]}"></label>
    <label>聖地の経度<input type="text" name="img" value="{$input["lng"]}"></label>
